...
<!-- ------------- Dates Table -->
    ...
    ?>
            <li style="display: flex;justify-content: center;"><a style="cursor:pointer" id="<?php echo $date_row['purchase_date']; ?>" onclick="getConversionData(this)"><?php echo "-----------------    ".$date_row['purchase_date']. "   ---------------- "; ?></a></li><br>
